...
function TestimonialsSection() {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      title: "Web Designer • Front-End Developer • Web Developer • UI/UX Engineer • Product Designer"
    },
    {
    ...
    },
    {
      ...
      title: "Frontend Web Developer & Designer | HTML, CSS, JavaScript, WordPress"
    },
    {
      ...
      title: "Skilled Front-End Developer | Crafting Engaging and Responsive Web Applications"
    },
    {
      ...
      {selectedTestimonial && (
        <div className="testimonial-modal-overlay" onClick={() => setSelectedTestimonial(null)}>
          <div className="testimonial-modal" onClick={(e) => e.stopPropagation()}>
            <button className="testimonial-modal-close" onClick={() => setSelectedTestimonial(null)}>
